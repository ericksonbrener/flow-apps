...
#flowHub{display:flex !important;align-items:center;justify-content:center;width:38px;height:38px;
  flex:0 0 auto !important;margin-right:10px;background:var(--bg3,#1a2228);
  border:1px solid var(--gbb,#2a2a2a);border-radius:10px;color:var(--t1,#fff) !important;
  text-decoration:none !important;opacity:.75;visibility:visible !important}
#flowHub:hover{opacity:1;border-color:#f97316 !important}
#flowHub svg{width:18px;height:18px;display:block}
